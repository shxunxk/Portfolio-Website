    ...
    const skills = {
        "webdev": {
            ...
            "Languages and Frameworks": {
                ...
                "CSS": {"img":'https://imgs.search.brave.com/QDzUzmK7oNgYEshF8l5T5wgMjGevyxUEreIxyefjuYA/rs:fit:860:0:0/g:ce/aHR0cHM6Ly8xMDAw/bG9nb3MubmV0L3dw/LWNvbnRlbnQvdXBs/b2Fkcy8yMDIwLzA5/L0NTUy1Mb2dvLTUw/MHgzMTMucG5n', "details":["Tailwind"]},
                                    ...
                                    <div key={category}>
                                        ...
                                        <div style={{display:'grid',gridTemplateColumns: "repeat(3, 1fr)", gap:'1%'}}>
                                            {Object.entries(items).map(([subCategory, subItems]) => (
                                                <div key={subCategory} style={{height:'300px', width:'100%', backgroundColor:'yellowgreen', borderRadius:'20px', display: 'flex', flexDirection:'column', alignItems:'center', padding:"5%"}}>
                                                    <img style={{height:'70%', padding:'5%'}} src = {subItems["img"]}/>
                                                    <h4>{subCategory}</h4>
