...
const WorkDetail = () => {
    ...
    return (
        <div className="head" style={{minHeight: '100vh', textAlign:'center', padding: '10%'}}>
            ...
            <p style={{paddingBottom:'10%', fontSize:"20px", textAlign:'left'}}>{curDet?.desc}</p>
            <div>
                {/* <img src={`/public/${curDet?.img}`}/> */}
            </div>
            {curDet && (
                <>
                    <div style={{paddingBottom:'50px', fontSize:"16px", textAlign:'left'}}>
                        <p>Tools and skills learnt/used : {curDet.tools}</p>
                    </div>
