          ...
          <section id = 'sec' className='about-content'>
            <motion.h2 style={{fontSize: '5rem'}} initial={{ x: 0 }} animate={{ x: scrollY > 400 ? -1000 : 0 }} transition={{ duration: 0.7 }}>Who Am I?</motion.h2>
              ...
              <section id='sec' className='education'>
                <motion.h2 style={{fontSize: '5rem', display: 'flex', flexDirection: 'column'}} initial={{ x: 0 }} animate={{ x: scrollY > 2600 ? -2000 : 0 }} transition={{ duration: 0.7 }}>Education</motion.h2>
                <motion.ul style={{fontSize: '2rem'}} initial={{ x: 0 }} animate={{ x: scrollY > 2600 ? -2000 : 0 }} transition={{ duration: 0.7 }}>Bachelors Degree in the field of Computer Science Engineering from Vellore Institute of Technology, Vellore</motion.ul>
              </section>
