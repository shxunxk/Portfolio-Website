...
export default function Education() {
  return (
    <section className='education'>
      <motion.h2
        style={{ fontSize: '5rem', textAlign: 'center', paddingTop: '5%'}}
        initial={{ x: -800 }}
        whileInView={{ x: 0 }}
      ...
      <div style={{padding: '50px'}}>
        <motion.div
          style={{ fontSize: '2rem', textAlign: 'center', paddingBottom: '50px' }}
          initial={{ x: -1000 }}
          whileInView={{ x: 0 }}
        ...
        >
          <motion.img
            ...
            alt="Location Image"
          />
          <p style={{ paddingBottom: '50px' }}>Based in Goa, India</p>
          <motion.img
            style={{ borderRadius: '20px', width: '300px', height: 'auto',}}
            ...
            alt="Location Image"
          />
          <p>Pursuing a Bachelors Degree in Computer Science Engineering from Vellore Institute of Technology, Vellore</p>
        </motion.div>
      </div>
    </section>
  );
