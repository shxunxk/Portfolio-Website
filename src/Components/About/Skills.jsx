          ...
          >
            ...
            {Object.keys(skills).map((categoryKey) => (
                <div key={categoryKey} className="skill-category">
                    <h3>{skills[categoryKey].Title}</h3>
                    {skills[categoryKey]['Area Covered'] && Object.keys(skills[categoryKey]['Area Covered']).map((skillKey) => (
                        <div key={skillKey} className="skill-item">
                            ...
                            <div className="skill-details">
                                ...
                                <ul>
                                <h4 style={{color:'black'}}>{skillKey}</h4>
                                    <p>{skillKey}</p>
                                    {skills[categoryKey]['Area Covered'][skillKey].details && skills[categoryKey]['Area Covered'][skillKey].details.map((detail, index) => (
